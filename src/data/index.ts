...
export const products: CardMenu = [
  ...
  },
  {
    id: 11,
    name: 'A double crunchy and fries',
    desc: 'Our Crunchy chicken x fries are ultra crispy and absolutely bursting with flavour topped with fresh lettuce , cucumbers ,Onions , our special sauce and cheese! Its an absolute crowd pleaser',
    image: '/img/burger-11.jpg',
    price: 21499,
  },
  {
